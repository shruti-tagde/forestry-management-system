...
public class CustomerBean
{
    ...
    public int insert()throws Exception{
        ...
        PreparedStatement pstmt = con.prepareStatement("insert into customer (Customer_id,Customer_Name,StreetAddress1,StreetAddress2,Town_City,Postcode,TelephoneNo,Email)values(?,?,?,?,?,?,?,?)");
